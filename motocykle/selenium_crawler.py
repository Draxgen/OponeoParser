...
#     go_to_page(driver, 'https://www.oponeo.pl/wybierz-opony-motocyklowe#**/')
#     print('Start getting data')
#     page = 1
#     while True:    
#         processed_name = f'page-{page}'
#         print(f'Page {page}')
#         if processed(processed_name):
#             print('Skip')
#             paginate(driver, page)
#             page += 1
#             continue
#         prepare_html(driver)
#         page += 1
#         add_processed(processed_name)
#         paginate(driver, page)
